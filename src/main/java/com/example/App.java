...
import com.example.test.scope.entity.Chinese;
...
public class App {
    ...
    public static void main(String[] args) {
        ...
        Chinese chinese1 = context.getBean("chinese", Chinese.class);
        Chinese chinese2 = context.getBean("chinese", Chinese.class);
        System.out.println("chinese1 = " + chinese1);
        System.out.println("chinese2 = " + chinese2);
        chinese1.hunt();
        chinese2.hunt();
    }
}
